...
public class FinalProject extends Application{
    ...
    public static SeatingChart testing () throws FileNotFoundException {
        ...
        Student one = new Student("Stephen", "", true, true);
        one.setId(1); a.students.put(1, one);
        Student two = new Student("Draymond", "", true, true);
        two.setId(2);a.students.put(2, two);
        Student three = new Student("Nemanja", "", true, true);
        three.setId(3);a.students.put(3, three);
        Student four = new Student("Jonathan", "", true, true);
        four.setId(4);a.students.put(4, four);
        Student five = new Student("PJ", "", false, true);  
        five.setId(5);a.students.put(5, five);
        Student six = new Student("Bamonte", "", true, false);
        six.setId(6);a.students.put(6, six);
        Student seven = new Student("JaeSean", "", true, true);
        seven.setId(7);a.students.put(7, seven);
        Student eight = new Student("Jimmy", "", true, true);   
        eight.setId(8);a.students.put(8, eight);
        Student nine = new Student("Jayson", "", true, true);
        nine.setId(9); a.students.put(9, nine);
        Student ten = new Student("Jaylen", "", false, true);
        ten.setId(10);a.students.put(10, ten);
        Student eleven = new Student("Luka", "", true, true);
        eleven.setId(11);a.students.put(11, eleven);
        Student twelve = new Student("Boban", "", true, false);
        twelve.setId(12);a.students.put(12, twelve);
        Student thirteen = new Student("Marjanovic", "", true, true);  
        thirteen.setId(13);a.students.put(13, thirteen);
        Student fourteen = new Student("Gregg", "", true, true);
        fourteen.setId(14);a.students.put(14, fourteen);
        Student fifteen = new Student("Strus", "", false, true);
        fifteen.setId(15);a.students.put(15, fifteen);
        Student sixteen = new Student("Andre", "", true, true);   
        sixteen.setId(16);a.students.put(16, sixteen);
        Student seventeen = new Student("Deandre", "",true, true);
        seventeen.setId(17); a.students.put(17, seventeen);
        Student eighteen = new Student("Iguodala", "", true, false);
        eighteen.setId(18);a.students.put(18, eighteen);
        Student nineteen = new Student("Klay", "", true, true);
        nineteen.setId(19);a.students.put(19, nineteen);
        Student twenty = new Student("Demarcus", "", false, false);
        twenty.setId(20);a.students.put(20, twenty);
        Student twentyone = new Student("Kawhi", "", true, true);  
        twentyone.setId(21);a.students.put(21, twentyone);
        Student twentytwo = new Student("Gabe", "", true, true);
        twentytwo.setId(22);a.students.put(22, twentytwo);
        Student twentythree = new Student("Vincent", "", true, true);
        twentythree.setId(23);a.students.put(23, twentythree);
        Student twentyfour = new Student("Kyle", "", true, false);   
